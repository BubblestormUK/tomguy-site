            ...
            <div className="col-md-6 slide-left">
              ...
              <div className="row mb-7 mb-md-0 mt-md-10">
                <div className="col-md-6 body_text_xs mb-4 mb-md-0">
                  ...
                  <p><span style={{ fontWeight: 400 }}>Since then I&apos;ve taken the same approach into bigger and more complex organisations. At Vodafone Smart Tech I was Chief Product Officer, leading the department&apos;s portfolio of pioneering consumer IoT products. I oversaw the development of a number of new category leading smart devices, as well as forging international partnerships with Disney and industry veteran Yves Béhar to create Neo, the smart kids watch in 2020, and defining the new design language and personality for all Vodafone&apos;s hardware.</span></p>
                  <p><span style={{ fontWeight: 400 }}>I then founded Etc., the incubation arm of BT, where I oversaw a team of around 200 to create and incubate startups in categories outside the core. At Etc. we built and scaled new ventures across health, energy, fintech, drones and AI, and transformed core platforms that BT&apos;s digital future depends on.</span></p>
                </div>
                <div className="col-md-6 body_text_xs">
                  <p><span style={{ fontWeight: 400 }}>Today I&apos;m Chief Digital Officer at Nido and Livensa Living, the pan European hospitality group backed by CPP Investments, where I lead the digital and product agenda across the platform. Alongside this I&apos;m co-founder of Boxxed.ai, a GenAI business helping small and medium sized companies embed AI into the way they work.</span></p>
                  <p><span style={{ fontWeight: 400 }}>With a passion for innovating within nascent sectors, I believe in using a relentless customer focus to build disruptive products that work right now and for the future, solving real customer problems and identifying solutions for their unmet needs, for direct to consumer and enterprise customers.</span></p>
